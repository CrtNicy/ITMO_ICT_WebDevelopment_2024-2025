"""
Django settings for django_project_фамилия project.
...
SECRET_KEY = 'django-insecure-jcsr@1_3x2akt!_1%859ij-@yg5*g4re22rw0yd70hxp-!%@d_'
...
ROOT_URLCONF = 'django_project_фамилия.urls'
...
WSGI_APPLICATION = 'django_project_фамилия.wsgi.application'
...
AUTH_USER_MODEL = 'project_first_app.User'  # Замените 'your_app_name' на имя вашего приложения
